...
class _JokeService implements JokeService {
  _JokeService(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  @override
  Future<ApiResponse<List<JokeDetailModel>>> getRecommendList(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ApiResponse<List<JokeDetailModel>>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    ...
    final value = ApiResponse<List<JokeDetailModel>>.fromJson(
      _result.data!,
      (json) => json is List<dynamic>
          ? json
              .map<JokeDetailModel>(
                  (i) => JokeDetailModel.fromJson(i as Map<String, dynamic>))
              .toList()
          : List.empty(),
    );
    return value;
  ...
  @override
  Future<ApiResponse<dynamic>> getLoginVerifyCode(String phone) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<dynamic>> publishJoke(
    String content,
    int type,
  ) async {
    const _extra = <String, dynamic>{};
